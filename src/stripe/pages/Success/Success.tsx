			...
			<div className="modal-content">
				<div className="container">
					...
					<h2 className={styles.subtitle}>
						{t(
							"Congratulations on one of the best decisions of your life! Your transformation starts today!"
						)}
					</h2>
					<h2 className={styles.subtitle}>
						{t(
							"Download the app using the link below and sign in using the email mentioned in your payment."
						)}
					</h2>
					<h2 className={styles.subtitle}>{t("See you inside!")}</h2>
					<div className={styles.wrapper}>
						<Link
							className={styles.text}
							href="https://play.google.com/store/apps/details?id=com.simbirsoft.next"
						>
							<Image
								src={GooglePlay}
								alt="Google play"
						...
						<Link
							className={styles.text}
							href="https://apps.apple.com/ru/app/next-%D1%82%D1%80%D0%B5%D0%BD%D0%B8%D1%80%D0%BE%D0%B2%D0%BA%D0%B8-%D0%B8-%D1%84%D0%B8%D1%82%D0%BD%D0%B5%D1%81/id1458490165"
						>
							<svg
